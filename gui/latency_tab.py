from utils import *
from core.loss_latency import get_latency


def init(parent):
    tab_latency = ttk.Frame(parent)
    parent.add(tab_latency, text="Monitoring opóźnienia")
...
def execute_on_click(entry_start_date, entry_end_date, entry_ip, image_label):
    ...
    plot_data = get_latency(f"{start_date}T00:00:00.000Z", f"{end_date}T00:00:00.000Z", ip)
